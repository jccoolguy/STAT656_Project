...
treyNumericWithMissing = treyPreprocessingNumeric
#Analyze variance...also center and scale
nearZeroVar(treyNumericWithMissing,
            saveMetrics = T)
treyPreprocessingNumericWVariance = treyNumericWithMissing %>% 
  preProcess(method = c('nzv')) %>%
  predict(newdata = treyNumericWithMissing)

dim(treyNumericWithMissing)

treyPreprocessedData = treyNumericWithMissing 
save(treyPreprocessedData,
     file="treyPreprocessedData.RData")
